...
#' @param chrom_file: path to the file containing chromosome names and lengths; default="~/src/NGS_utils/data/chromosome.lengths.hg19.txt"
#' 
#' @param assembly: genome assembly that reads were mapped to; default="hg19" 
...
samplesheetToTrackHub <- function(samplesheet, hub_name=NULL, chrom_file="~/src/NGS_utils/data/chromosome.lengths.hg19.txt", assembly="hg19", mountpoint=MOUNTPOINT_PATH, http_address=MOUNTPOINT_HTTP_ADDRESS){
...
#' @param mountpoint: path to the directory where the track hub folder will be saved in. This directory should be associated with an http address or an ftp address; default=Sys.getenv("MOUNTPOINT_PATH")
#' @param http_address: http or ftp address associated with the mountpoint; default=Sys.getenv("MOUNTPOINT_PATH")
multiseqToTrackHub <- function(region, hub_name="multiseq", multiseq_folder="./results_run_multiseq/", chrom_file="~/src/NGS_utils/data/chromosome.lengths.hg19.txt", assembly="hg19", mountpoint=MOUNTPOINT_PATH, http_address=MOUNTPOINT_HTTP_ADDRESS){
